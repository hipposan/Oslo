...
extension Meals: CustomStringConvertible {
  public var description: String {
    switch self {
    case .hamburgerAndChips: return localize(with: "My favorite! You a good people!")
    case .chikenAndCoke: return localize(with: "Delicious! I gain weight")
    case .lollipopAndCoffee: return localize(with: "I don't drink coffee. But this good")
    }
  }
}
